...
if(txt=="tema3.html"){
$(document.getElementById("contframe").setAttribute('src','tema4.html'));
progreso7();
	if(iPuntosObtenidos==400){
			iPuntosObtenidos=500;
			guardarpuntos();
...
progreso11();
	if(iPuntosObtenidos==800){
			iPuntosObtenidos=900;
			guardarpuntos();
			}else{
			guardarpuntos();
				}
...
function progreso3() {
	...
	$("#descriptema").html("Medidas relativas y absolutas");
...
function progreso5() {
	...
	$("#descriptema").html("La altura de la x")
	$(".chulotema2").fadeIn('fast');
	$("#pantallamenuact").fadeOut('fast');
}
function progreso6() {
	...
	$("#descriptema").html("Terminología Básica")
...
function progreso7() {
	...
	$("#descriptema").html("Cuadrícula o rejilla base");
