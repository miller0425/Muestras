...
function irpresentacion(){
	$(document.getElementById("contframe").setAttribute('src','bienvenida.html')); //aqui se coloca el archivo correspondiente a la pagina # presentacion
	progreso1();
...
function ircontenidos(){
	$(document.getElementById("contframe").setAttribute('src','images/unidad1.jpg')); //aqui se coloca el archivo correspondiente a la pagina # objetivos
	progreso3();
...
function menuslider(){
	...
	cierreayuda();
	$("#contenidomenu").toggle("slide","linear",500);
	$("#btnpresentacionmenu").toggle("slide","linear",500);
	$("#btnobjetivosmenu").toggle("slide","linear",500);
	$("#btncontenidosmenu").toggle("slide","linear",500);
	$("#btnactividades").toggle("slide","linear",500);
	$("#btnbibliografia").toggle("slide","linear",500);
	$("#btncierre").toggle("slide","linear",500);
	$("#btncreditos").toggle("slide","linear",500);
	switch (pestanapos.left){
		case 0:		
		$( "#pestanamenu" ).css({"transform":"translateX(218px)",
		...
		break;
		case 218:
		$( "#pestanamenu" ).css({"transform":"translateX(0px)",
		"transition":"0.45s linear",
		"-moz-transition":"0.45s linear",
     	"-webkit-transition":"0.45s linear",
     	"-o-transition":"0.45s linear"});
...
if(txt=="logros.html"){
$(document.getElementById("contframe").setAttribute('src','images/unidad1.jpg'));
progreso3();
	if(iPuntosObtenidos==100){
			iPuntosObtenidos=150;
			guardarpuntos();
...
//document.getElementById('txt2').value = txt;
if(txt=="logros.html"){
$(document.getElementById("contframe").setAttribute('src','bienvenida.html'));
progreso1();
}
if(txt=="images/unidad1.jpg"){
$(document.getElementById("contframe").setAttribute('src','logros.html'));
...
function progreso4() {
	...
	$("#descriptema").html("Antecedentes de la PNL")
...
function progreso6() {
	...
	$("#descriptema").html("Formato de texto y Caracteres especiales ")
